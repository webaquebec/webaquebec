...
import { titleStyle, h2Style, unorderedListStyle } from '../styles/global';
      ...
      <Center maxWidth='854px' gutters='var(--container-gutter)'>
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            ...
            la vie privée. C’est pourquoi le Web Québec (WAQ) s’engage à
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            Il est à noter que le site Web et son contenu demeurent la propriété
            de l’opérateur.
          </p>
        </Stack>
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            ...
            inscrites dans le formulaire de commentaire, mais aussi ton adresse
            IP et l’agent utilisateur de ton navigateur sont collectés pour nous
          ...
          <p>
            Après validation de ton commentaire, ta photo de profil sera visible
            publiquement à côté de ton commentaire. Les commentaires des
            visiteurs peuvent être vérifiés à l’aide d’un service automatisé de
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            Si tu es un(e) utilisateur(trice) enregistré(e) et que tu téléverses
            des images sur le site Web, nous te conseillons d’éviter de
            téléverser des images contenant des données EXIF de coordonnées GPS.
            Les visiteurs de notre site Web peuvent télécharger et extraire des
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            Si tu déposes un commentaire sur notre site Web, il te sera proposé
            d’enregistrer ton nom, adresse de messagerie et site Web dans des
            cookies. C’est uniquement pour ton confort afin de ne pas avoir à
            saisir ces informations si tu déposes un autre commentaire plus
            tard. Ces cookies expirent au bout d’un an.
          </p>
          ...
          <p>
            Lorsque tu te connectes, nous mettons en place un certain nombre de
            cookies pour enregistrer tes informations de connexion et tes
            préférences d’écran. La durée de vie d’un cookie de connexion est de
            deux jours, celle d’un cookie d’option d’écran est d’un an. Si tu
            coches « Se souvenir de moi », le cookie de connexion sera conservé
            pendant deux semaines. Si tu te déconnectes de ton compte, le cookie
            de connexion sera effacé.
          </p>
          ...
          <p>
            ...
            donnée personnelle. Il indique simplement l’identifiant de l’article
            que tu dois modifier. Il expire au bout d’un jour.
          </p>
        </Stack>
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            ...
            exemple, des vidéos, images, des widgets, etc.). Le contenu intégré
            depuis d’autres sites se comporte de la même manière que si le(la)
            visiteur(euse) se rendait sur cet autre site.
          </p>

          <p>
            Ces sites Web pourraient collecter des données sur toi, utiliser des
            cookies, embarquer des outils de suivis tiers, suivre tes
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            ...
            navigateur enregistre un cookie pour une durée maximale d’un an pour
            que nous puissions diffuser de la publicité pertinente via le réseau
            Google AdWords et le pixel Facebook.
          </p>
        </Stack>
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            Ce site collecte des données anonymes sur l’audience pour mesurer la
            portée du site Web.
          </p>
        </Stack>
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            Si tu laisses un commentaire, le commentaire et ses métadonnées sont
          ...
          <p>
            ...
            conservées indéfiniment sur nos serveurs internes et/ou dans un CRM.
            L’accès à nos serveurs physiques est restreint aux seules personnes
            qui disposent de l’autorisation d’y accéder. Nous nous engageons à
            reconnaître un droit d’accès et de rectification aux personnes
            concernées et désireuses de consulter, modifier, voire radier les
            informations les concernant. Il est à noter que les abonné(e)s à
            notre liste de diffusion peuvent se désabonner à tout moment.
          </p>
        </Stack>
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            ...
            retrait quant à tes renseignements personnels. Le droit d’opposition
            ...
            certaines fins mentionnées lors de la collecte (voir la section «
            Collecte des renseignements personnels »). Le droit de retrait
            s’entend comme étant la possibilité offerte aux internautes de
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            Si tu as un compte ou si tu as laissé des commentaires sur ce site,
            tu peux demander à recevoir un fichier contenant toutes les données
            personnelles que nous possédons à ton sujet, incluant celles que tu
            nous as fournies. Tu peux également demander la suppression des
            données personnelles te concernant, de même que la rectification si
            les renseignements sont inexacts, incomplets ou équivoques. Ceci ne
            prend pas en compte les données conservées à des fins
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            ...
            et l’utilisation des renseignements personnels seront assujetties à
            la version de la politique alors affichée et en vigueur.
          </p>
        </Stack>
        ...
        <Stack space='var(--space)' css={stackStyle}>
          ...
          <p>
            ...
            conditions d’utilisation, et ce, afin d’éviter toute interprétation
            disparate entre les deux versions.
          </p>
        </Stack>
