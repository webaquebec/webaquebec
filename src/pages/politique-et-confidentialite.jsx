      ...
      <Stack space='4rem'>
        ...
        <Stack>
          ...
          <p>
            ...
            (opérateur). L’utilisateur qui consulte le site Web est lié par les
        ...
        <Stack>
          ...
          <p>
            ...
            travers de formulaires et l’interactivité établie entre vous et
          ...
          <p>
            ...
            pour un projet donné serviront seulement pour ce projet et ne seront
            en aucun temps transférés aux autres projets de l’organisation.
          </p>
        </Stack>
        ...
        <Stack>
          ...
          <p>
            Nous collectons les renseignements des utilisateurs qui s’inscrivent
            à notre liste de diffusion (nom, prénom, adresse électronique). Nous
        ...
        <Stack>
          ...
          <p>
            ...
            qui disposent de l’autorisation d’y accéder.
          </p>
        </Stack>
        ...
        <Stack>
          ...
          <p>
            Il est à noter que les abonnés à notre liste de diffusion peuvent se
            désabonner à tout moment.
          </p>

          <p>
            Nous nous engageons ainsi à vous offrir un droit d’opposition et de
          ...
          <p>
            Pour pouvoir exercer ces droits, vous pouvez communiquer directement
        ...
        <Stack>
          ...
          <p>
            Pour ce faire, vous pouvez communiquer directement avec notre équipe
            par:
          </p>
        ...
        <Stack>
          ...
          <p>
            ...
            la suppression des données personnelles vous concernant, de même que
            la rectification si les renseignements sont inexacts, incomplets ou
            équivoques. Ceci ne prend pas en compte les données conservées à des
            fins administratives, légales ou pour des raisons de sécurité.
          </p>
        </Stack>
        ...
        <Stack>
          ...
          <p>
            <em>
              Veuillez noter que le genre masculin est utilisé dans ce document
