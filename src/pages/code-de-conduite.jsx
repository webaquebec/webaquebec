        ...
        <li>
          ...
          <Stack space='var(--space)' css={stackStyle}>
            ...
            <ul css={unorderedListStyle}>
              ...
              <li>
                maintenir la confidentialité des informations obtenues au cours
                de votre participation au WAQ.
              </li>
            </ul>
          </Stack>
        </li>
        <li>
          ...
          <Stack space='var(--space)' css={stackStyle}>
            ...
            <p>
              ...
              orientation sexuelle, état civil, âge sauf dans la mesure prévue
              par la loi, religion, convictions politiques, langue, condition
              sociale, handicap ou utilisation d’un moyen pour pallier ce
              handicap); et qui sont de nature à porter atteinte à la dignité, à
              l’intégrité physique ou psychologique de la personne ou de nature
              à compromettre son activité.
            </p>
            <p>
              Les expressions et les images à connotation sexuelle ne sont pas
              non plus appropriées dans l’enceinte de l’événement, ce qui inclut
              les conférences, les ateliers, les soirées, ainsi que les réseaux
